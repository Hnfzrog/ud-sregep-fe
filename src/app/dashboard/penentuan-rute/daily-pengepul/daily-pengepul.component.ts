...
@Component({
  selector: 'app-daily-pengepul',
  templateUrl: './daily-pengepul.component.html',
  styleUrls: ['./daily-pengepul.component.scss']
})
export class DailyPengepulComponent implements OnInit {
rows: Array<any> = [];
  columns: Array<any> = [];
  data: any;
